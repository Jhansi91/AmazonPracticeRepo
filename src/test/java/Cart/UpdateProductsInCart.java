...
public class UpdateProductsInCart extends BaseClass
{
	@Test
	public void UpdateProductsInCartTest() throws Throwable {
		...
		String qty=elib.getData("ProductData", 0, 1);
		...
		cart.getQtyDD().click();
		cart.selectQty(driver, qty);
		
		String actualqty = validation.updateQtyvalidation(qty);
